...
<xsl:stylesheet 
  ...
  <fo:block font-size="12pt">
    <fo:block font-family="sans-serif"
              ...
              text-align="justify">
      <fo:block border-bottom="solid 2px black"
                margin-bottom="5pt" font-weight="bold">
        Desayuno
      </fo:block>
      <fo:block>
      ...
      <fo:block>
        <fo:inline font-weight="bold">Precio: </fo:inline>
        <xsl:value-of select="precio"/>
      </fo:block>
      <fo:block>
        <fo:inline font-weight="bold">Descripción: </fo:inline>
        <xsl:value-of select="descripcion"/>
      </fo:block>
      <fo:block>
        <fo:inline font-weight="bold">Calorías: </fo:inline>
